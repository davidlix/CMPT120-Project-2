 //locations.js    Final Project DONE!    
         ...
         var location = [];          
          switch (currentlocation){    
              ...
              case 4 : Items    [4] = East1 =  new itemDesc("Nothing on the ground.");
                                       UpdateDisplay (East1);
                       location [4] =  East1 = new locationInfo ("you are inside the cave.", location4());
                                       UpdateDisplay (East1); 
              ...
              case 7 : Items    [7] = South2 =  new itemDesc("There are some food on the trees");
              ...
              case 9 : Items    [9] = West2 =  new itemDesc("There is a volleyball on the edge .");
                                       UpdateDisplay (West2);
    ...
    function Win (){
             if ((volleyball === true) && (food === true) && (woods === true) && (bagpack === true) && (suitcase === true))
    ...
    function Take (){  
      switch (currentlocation) {  
          ...
          case 2:
          if (bagpack === true){
          UpdateDisplay ("You already taken the bagpack");
          }else{
            inventory.push("You have bagpack in your inventory.");
            UpdateDisplay ("You have picked up a bagpack");
          bagpack = true;
          Win();
          }
          ...
          case 5:
          if (woods === true){
          UpdateDisplay ("You already have woods.");
          }else{
          ...
          case 7:
          if (food === true){
          UpdateDisplay ("You already have food.");
          }else{
            inventory.push("You have foods in your inventory.");
            UpdateDisplay ("You have picked up some food");
          food = true;
          Win();
          }
